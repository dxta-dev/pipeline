...
CREATE TABLE `merge_request_fact_users_junk` (
	...
	FOREIGN KEY (`committer1`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer2`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer3`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer4`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer5`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer6`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer7`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer8`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer9`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
	FOREIGN KEY (`committer10`) REFERENCES `forge_users`(`id`) ON UPDATE no action ON DELETE no action,
