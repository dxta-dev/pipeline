...
export const repositoryShaTrees = sqliteTable('repository_sha_trees', {
  shaId: integer('sha_id').references(() => repositoryShas.id).notNull(),
  parentId: integer('parent_id').references(() => repositoryShas.id).notNull(),
