...
export type MergeRequestEventType = typeof MergeRequestEvents[number];
export type ReviewStateType = typeof ReviewStates[number];

export const MergeRequestEvents = [
  'unknown',
  'opened',
  'started_coding',
  'started_pickup',
...
export const mergeRequestEvents = sqliteTable('timeline_events', {
  ...
  mergeRequestEventType: Enum('merge_request_event_type', { enum: MergeRequestEvents }).notNull(),
