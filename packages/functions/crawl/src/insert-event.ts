import { EventDetailType, EventNamespaceType, CrawlInfo, CrawlFailed, CrawlComplete, CrawlInfoSchema, CrawlFailedSchema, CrawlCompleteSchema } from "@acme/crawl-schema/src/events";
