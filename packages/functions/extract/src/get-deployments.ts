...
export type GetDeploymentsSourceControl = Pick<
  SourceControl,
  "fetchDeployments"
>;
export type GetDeploymentsEntities = Pick<
  Entities,
  "deployments" | "repositoryShas"
>;

export type GetDeploymentsFunction = ExtractFunction<
  GetDeploymentsInput,
...
export const getDeployments: GetDeploymentsFunction = async (
  ...
  const { deployments, pagination } =
    await integrations.sourceControl.fetchDeployments(
      repository,
      namespace,
      perPage,
      environment,
