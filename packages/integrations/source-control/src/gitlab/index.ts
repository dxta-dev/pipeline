...
import type { NewRepository, NewNamespace, NewMergeRequest, NewMember, NewMergeRequestDiff, Repository, Namespace, MergeRequest, NewMergeRequestCommit, NewMergeRequestNote, NewTimelineEvent } from "@acme/extract-schema";
...
export class GitlabSourceControl implements SourceControl {
  ...
  fetchTimelineEvents(_repository: Repository, _namespace: Namespace, _mergeRequest: MergeRequest): Promise<{ timelineEvents: NewTimelineEvent[]; }> {
