import type { NewRepository, NewNamespace, NewMergeRequest, NewMember, NewMergeRequestDiff, NewMergeRequestCommit, NewMergeRequestNote, NewTimelineEvents, NewCicdWorkflow, NewCicdRun, NewCommit, NewDeployment, Deployment } from "@dxta/extract-schema";
...
export interface SourceControl {
  ...
  fetchDeployments(repository: Repository, namespace: Namespace, perPage: number, environment?: string, page?: number): Promise<{ deployments: NewDeployment[], pagination: Pagination }>;
